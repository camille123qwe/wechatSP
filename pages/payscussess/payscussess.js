...
Page({
  ...
  data: {
    ...
    remaiicon: '/assests/icon/odersimg/icon_nihaihuimai@2x.png'
  },
  errorFunction: function (e) {
    var errorImgIndex = e.target.dataset.errorimg //获取循环的下标
    var imgObject = "goodslist[" + errorImgIndex + "].goodsface" //carlistData为数据源，对象数组
    var errorImg = {}
    errorImg[imgObject] = "1l17veb29tepb7pds1cfqjj8si.jpg" //我们构建一个对象
  ...
  order(){
    wx.navigateTo({
      url: '../orderinformation/orderinformation?orderid='+this.data.orderid,
    })
  },
  gohome(){
    wx.switchTab({
